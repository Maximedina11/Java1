...
///	? Ingresar Botellas: Primero preguntaremos cuántas botellas se va a ingresar al sistema. Una vez que tenemos el número vamos a usar un bucle para, 
/// a fin de ir ingresando cada botella. En	cada ciclo del bucle se debe generar un número aleatorio entre 100 y 3000 gr, 
/// que va a ser el peso de las botellas a reciclar (simulando que el usuario está ingresando botellas en la máquina). 
...
Algoritmo recicladora
	definir i, j, saldo, control, cant_botella, cuent_botella, num_azar, a_pagar  Como Entero
	...
	Repetir
		...
		leer pass
		si control=3
			escribir "supero numero de intentos"
			control=0
		FinSi
	Mientras Que pass <> "caramelosDeLimon" 
			...
			Segun option Hacer
				"I","i":
					...
					si  pago = "S" Entonces //consicion True
						...
						Escribir "ACREDITANDO SALDO..."//: $",a_pagar//no lo pide pero lo agrege lo tendria que agrgar y consulte el salgo
					...
					SiNo// de lo contrario
						...
						Escribir "Devolviendo material" ///  (sólo mostrar en pantalla "Devolviendo material"). Para esto usaremos un condicional doble.
				...
				"S","s" : 
					Escribir "" // salto de linea
					Escribir "SALIR DEL SISTEMA" ///	 ? Tanto al terminar "Ingresar Botellas" como "Consultar Saldo" debe volver al menú principal.
			FinSegun
		FinSi
