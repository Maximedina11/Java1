...
Algoritmo Ej_6_matrices
	...
	definir i , j , f ,c , contador , matriz , suma1 , suma2, suma3, suma4  Como Entero
	suma1 = 0
	suma2= 0 
	suma3 = 0 
	suma4 = 0
	...
	si f == c y f < 10 entonces
		...
		Para i = f - 1 Hasta 0 Hacer
			Para j = c - 1 Hasta 0 Hacer
				si j == i Entonces
					suma4 = suma4 + matriz(j, i)
				FinSi
			FinPara
			Escribir "La suma de los valores de la diagonal secundaria es : " , suma4
		FinPara
	...
	si suma1 = suma2 y suma2 = suma3 y suma3 = suma4 y suma4 = suma1 Entonces
